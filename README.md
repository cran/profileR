...
[![Build Status](https://travis-ci.org/cddesja/profileR.svg?branch=master)](https://app.travis-ci.com/cddesja/profileR) [![codecov.io](http://codecov.io/github/cddesja/profileR/coverage.svg?branch=master)](https://app.codecov.io/github/cddesja/profileR?branch=master) 
...
> Bulut, O., & Desjardins, C. D. (2020). *Profile analysis of multivariate data: A brief introduction to the profileR package*. Retrieved from [https://osf.io/preprints/psyarxiv/sgy8m](https://osf.io/preprints/psyarxiv/sgy8m). doi: 10.31234/osf.io/sgy8m
